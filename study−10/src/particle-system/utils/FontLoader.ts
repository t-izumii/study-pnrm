...
export class FontLoader {
  private static readonly GOOGLE_API_URL = "https://fonts.googleapis.com/css?family=";
  ...
  static async loadFont(options: FontLoadOptions): Promise<void> {
    try {
      ...
      console.log(`フォント "${familyName}" の全ウェイト読み込みが完了しました`);
   ...
   */
  static async loadMultipleFonts(fontOptions: FontLoadOptions[]): Promise<void> {
